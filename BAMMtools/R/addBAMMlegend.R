...
##' automatically inferred, otherwise can be specified as horizontal or vertical.
##' @param side side for tick marks, see \code{\link{axis}} documentation. Automatically
##' inferred if omitted.
##' @param location either a location name (see Details), or coordinates for the
##' corners of the bar legend c(xmin, xmax, ymin, ymax).
...
##' @param longFrac Percent of the plot width range that will be used as the long
##' dimention of the legend. Only applies to preset location options.
