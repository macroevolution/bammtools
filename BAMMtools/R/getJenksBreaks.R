...
##'
##' @description Given a vector of numeric values and the number of desired categories, calculate
##' the optimum breakpoints using Jenks natural breaks optimization.
##'
##' @param var numeric vector
##' @param k number of groupings
##' @param subset Number of regularly spaced samples to subset from \code{var}. Intended to
##' improve runtime for large datasets. If \code{NULL}, all values are used.
##'
##' @details \code{getJenksBreaks} is called by \code{\link{assignColorBreaks}}.
##' 
...
##' @author Pascal Title
##'
##' @seealso See \code{\link{assignColorBreaks}} and \code{\link{plot.bammdata}}.
##'
##' @examples
##' \dontrun{
##' # load whales dataset
